    ...
    >
      <section className="rounded-[24px] border border-[#f3ebe3] bg-[#fffaf5] p-4">
        ...
        <p className="mt-2 text-sm leading-7 text-[#4b5563]">
          Yalnizca yetkili admin hesabi bu alana erisebilir. Giris yaptiktan sonra yonetim
          paneline devam edeceksin.
        </p>
      </section>
      ...
      <div className="space-y-2">
        ...
        <p className="text-sm leading-6 text-[#6b7280]">
          Guvenlik icin sifre alani gizlidir ve yanlis denemelerde teknik detay gosterilmez.
        </p>
